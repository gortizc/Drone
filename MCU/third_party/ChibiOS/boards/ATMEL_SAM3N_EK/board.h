...
/*
 * Setup for the Atmel SAM3N-EK development board.
 */

/*
 * Board identifier.
 */
#define BOARD_ATMEL_SAM3N_EK
#define BOARD_NAME      "Atmel SAM3N-EK (SAM3N4C)"

/*
 * Select your platform by modifying the following line.
 */
#if !defined(SAM3_PLATFORM)
#define SAM3_PLATFORM   SAM3N4C
#endif
...
#define PIOA_LED4       0
#define PIOA_LED4_MASK  (1 << PIOA_LED4_MASK)
