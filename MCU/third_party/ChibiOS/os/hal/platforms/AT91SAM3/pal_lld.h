...
/**
 * @file    AT91SAM3/pal_lld.h
 * @brief   AT91SAM3 PIO low level driver header.
 *
 * @addtogroup PAL
 * @{
 */
...
typedef struct {
  ...
  uint32_t      pusr;
} at91sam3_pio_setup_t;

/**
 * @brief   AT91SAM3 PIO static initializer.
 ...
 */
typedef struct {
  /** @brief Port 0,1 and 2 setup data.*/
  at91sam3_pio_setup_t P0Data;
  at91sam3_pio_setup_t P1Data;
  at91sam3_pio_setup_t P2Data;
} PALConfig;
...
/**
 * @brief   PIO port A,B and C identifier.
 */
#define IOPORT1   PIOA
#define IOPORT2   PIOB
#define IOPORT3   PIOC
