...
/**
 * @file    GCC/ARMCMx/AT91SAM3S/vectors.c
 * @brief   Interrupt vectors for the AT91SAM3S family.
 *
 * @defgroup ARMCMx_AT91SAM3S_VECTORS AT91SAM3S Interrupt Vectors
 * @ingroup ARMCMx_SPECIFIC
 * @details Interrupt vectors for the AT91SAM3S family.
 * @{
 */
...
extern void Vector68(void);      /* 10 SMC */
...
extern void VectorC0(void);      /* 32 CRC Calculation Unit */
extern void VectorC4(void);      /* 33 Analog Comparator */
extern void VectorC8(void);      /* 34 USB Device Port */
extern void VectorCC(void);      /* 35 not used */
#endif

/**
 * @brief   AT91SAM3S vectors table.
 */
#if !defined(__DOXYGEN__)
